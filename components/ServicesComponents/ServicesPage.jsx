        ...
        <div className="container mx-auto px-6 relative z-10">
          ...
          >
            ...
            >
              <Link
                href="/contact"
                className="inline-flex items-center justify-center gap-2 rounded-full bg-linear-to-r from-primary to-secondary px-7 py-4 text-sm font-bold text-white shadow-lg shadow-primary/20 transition-all hover:-translate-y-0.5 hover:shadow-primary/30"
              >
                Start a Project
                <ArrowRight size={18} />
              </Link>
